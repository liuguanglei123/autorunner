...
IMPLEMENT_DYNAMIC(CCUserInfoRecSet, CRecordset)


CCUserInfoRecSet::CCUserInfoRecSet(CDatabase* pdb)
	: CRecordset(pdb)
{
	m_SERV_ID = 0.0;
	m_GROUP_TYPE = 0.0;
...
CCUserInfoRecSet::CCUserInfoRecSet()
{
	m_SERV_ID = 0.0;
	m_GROUP_TYPE = 0.0;
	m_GROUP_ID = 0.0;
...
void CCUserInfoRecSet::DoFieldExchange(CFieldExchange* pFX)
{
...
#ifdef _DEBUG
void CCUserInfoRecSet::AssertValid() const
{
	CRecordset::AssertValid();
}

void CCUserInfoRecSet::Dump(CDumpContext& dc) const
{
	CRecordset::Dump(dc);
}
#endif //_DEBUG